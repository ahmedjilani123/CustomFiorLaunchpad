		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapadadvlauchpad-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapadadvlauchpad-display": {
								"semanticObject": "sapadadvlauchpad",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ad.advlauchpad",
									"url": sap.ui.require.toUrl("sap/ad/advlauchpad")
								}
							}
						}
					}
